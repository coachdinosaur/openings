...
const lines: VariationNode[] = [
  ...
  line("ch2-c1-main", "C1) 9...Rb8", C_BASE, ["Rb8", "Qe2", "b5", "b3", "cxb3", "axb3", "Rb6", "Ra5", "a6", "Nc3", "Be7", ["d5", "d5N"], "exd5", "Nxd5", "Nfxd5", "Rd1"], spanId(30, "left")),
  ...
  line("ch2-c1-bb4-castle", "The 13...Bb4 and 14...O-O line", [...C_BASE, "Rb8", "Qe2", "b5", "b3", "cxb3", "axb3", "Rb6", "Ra5"], ["Bb4", "Bb2", "O-O", ["d5", "d5!"], "exd5", "Bxf6", "gxf6", "Bxd5", "Qe6", ["Qc2", "Qc2N"], "Ne5", "Rxa7"], spanId(30, "right")),
...
const blocks: LessonBlock[] = [
  heading("ch2-index-heading", P24, "Chapter 2 - Catalan · 4...dxc4 and 5...Bd7"),
  prose("ch2-index", P24, "Variation Index: 1.d4 Nf6 2.c4 e6 3.g3 d5 4.Nf3 dxc4 5.Bg2 Bd7 6.Ne5 Bc6 7.Nxc6 Nxc6 8.O-O. A) 8...Be7, B) 8...Nd5!?, C) 8...Qd7 9.e3, C1) 9...Rb8 and C2) 9...O-O-O.", selected("ch2-opening", [["1.d4", 0], ["Nf6", 1], ["2.c4", 2], ["e6", 3], ["3.g3", 4], ["d5", 5], ["4.Nf3", 6], ["dxc4", 7], ["5.Bg2", 8], ["Bd7", 9], ["6.Ne5", 10], ["Bc6", 11], ["7.Nxc6", 12], ["Nxc6", 13], ["8.O-O", 14]])),
  ...
  sequence("ch2-sixth", spanId(25, "left"), "6.Ne5 Bc6", selected("ch2-opening", [["6.Ne5", 10], ["Bc6", 11]])),
  prose("ch2-sixth-note", spanId(25, "left"), "Definitely the most challenging move. The most popular continuation is a logical follow-up to Black's previous move."),
  variation("ch2-early-nc6-block", spanId(25, "left"), "Putting the other piece on c6", "6...Nc6 7.Nxc4 leaves Black's light-squared bishop passive on d7. After 7...Bb4+ 8.Nc3 Nd5 9.Qd3 Qf6 10.e3 Qg6 11.Be4 Qh5 12.O-ON O-O 13.a3 Be7 14.Bg2, White has a pleasant edge.", "ch2-early-nc6", refs("ch2-early-nc6"), "CH2-D05"),
  ...
  variation("ch2-razuvaev-block", spanId(25, "right"), "Razuvaev's recommendation", "9.O-O!? Nxc3 10.bxc3 Bxc3 11.Rb1 gives White strong bishop-pair compensation and lasting pressure.", "ch2-razuvaev", refs("ch2-razuvaev")),
  variation("ch2-razuvaev-worse-block", spanId(25, "right"), "Much worse for Black", "9...Bxc3 10.bxc3 Nxc3 11.Qd3 Nxd4 12.Re1! Ndxe2+ 13.Rxe2 Nxe2+ 14.Qxe2 O-O 15.Ba3 Re8 16.Rd1 Qc8 17.Na5 c6 18.Nc4!+- leaves Black unable to survive the pressure.", "ch2-razuvaev-worse", refs("ch2-razuvaev-worse")),
  ...
  variation("ch2-nxd4-block", spanId(25, "right"), "The dubious 8...Nxd4?!", "8...Nxd4?! 9.Bxb7 Rb8 10.Bg2 Qd7 11.e3 Nf5 12.Qc2 Qb5 13.Nd2 Nd6 14.b3 cxb3? 15.Bc6+N Kd8 16.axb3 gives White a decisive advantage.", "ch2-nxd4", refs("ch2-nxd4"), "CH2-D06"),
  diagramBlock("ch2-d06-block", spanId(25, "right"), "CH2-D06"),

  variation("ch2-nxd4-c5-block", spanId(26, "left"), "Black's active try", "10...Bc5 11.Nd2 c3 12.bxc3 Nb5 13.Qc2 still leaves White with a long-term advantage thanks to the bishop pair and healthier pawn structure.", "ch2-nxd4-c5", refs("ch2-nxd4-c5"), "CH2-D07"),
  ...
  heading("ch2-c-nd5-heading", spanId(29, "right"), "9...Nd5"),
  prose("ch2-c-nd5-intro", spanId(29, "right"), "This is met strongly by 10.Nd2!"),
  ...
  variation("ch2-c1-bb4-block", spanId(30, "left"), "The active 12...Bb4", "12...Bb4 13.Ra6 Nd5 14.Bb2 Rb6 15.Rxb6 axb6 16.Qxb5 Na5 17.Qd3 O-O 18.e4 Nf6 19.Rd1 leaves White with a pleasant Catalan edge, the bishop pair and a strong centre.", "ch2-c1-bb4", refs("ch2-c1-bb4"), "CH2-D17"),
  ...
  sequence("ch2-c1-main-continue", spanId(30, "right"), "13.Ra5 a6 14.Nc3 Be7 15.d5N", selected("ch2-c1-main", [["13.Ra5", 7], ["a6", 8], ["14.Nc3", 9], ["Be7", 10], ["15.d5N", 11]])),
  ...
  sequence("ch2-c1-exchanges", spanId(31, "left"), "15...exd5 16.Nxd5 Nfxd5 17.Rd1", selected("ch2-c1-main", [["15...exd5", 12], ["16.Nxd5", 13], ["Nfxd5", 14], ["17.Rd1", 15]])),
  prose("ch2-c1-finish", spanId(31, "left"), "White retains a pleasant advantage. The source continuation uses Bf3, Bg4, Bd7+ and Ba3 to keep Black's king tied down before the queen enters on b2."),
  ...
  variation("ch2-c2-h5-unclear-block", spanId(31, "right"), "The early bishop exchange", "After 10...h5 11.Bxc6 Qxc6 12.Qxc6 bxc6 13.Nd2 h4 14.Nxc4 Bd6 15.Kg2 Rh5 16.Bd2 Rdh8, the position is surprisingly unclear.", "ch2-c2-h5-unclear", refs("ch2-c2-h5-unclear")),
  variation("ch2-c2-h5-block", spanId(31, "right"), "White's additional option against 10...h5", "10...h5 11.Nd2 Nd5 12.Nxc4 h4 13.Bd2 Kb8 14.Rfc1 f5 15.b4! Bd6 16.b5 Nce7 17.Qb3N prepares the a-pawn advance.", "ch2-c2-h5", selected("ch2-c2-h5", [["10...h5", 0], ["11.Nd2", 1], ["Nd5", 2], ["12.Nxc4", 3], ["h4", 4], ["13.Bd2", 5], ["Kb8", 6], ["14.Rfc1", 7], ["f5", 8], ["15.b4!", 9], ["Bd6", 10], ["16.b5", 11], ["Nce7", 12], ["17.Qb3N", 13]]), "CH2-D21"),
  diagramBlock("ch2-d21-block", spanId(31, "right"), "CH2-D21"),

  variation("ch2-c2-h5-finish", spanId(32, "left"), "The a-pawn joins the attack", "17...Ng8 18.a4 Ngf6 19.a5 hxg3 20.hxg3 g5 21.b6 cxb6 22.Nxb6! wins the attacking race.", "ch2-c2-h5", selected("ch2-c2-h5", [["17...Ng8", 14], ["18.a4", 15], ["Ngf6", 16], ["19.a5", 17], ["hxg3", 18], ["20.hxg3", 19], ["g5", 20], ["21.b6", 21], ["cxb6", 22], ["22.Nxb6!", 23]]), "CH2-D22"),
  ...
  variation("ch2-c2-premature-block", spanId(32, "left"), "Why 13.b4 is premature", "13.b4 Ncxb4! 14.Bxb4 Bxb4 15.e4 Nf4! 16.gxf4 Qxd4 17.Qxd4 Rxd4 gives Black enough activity, while 15.Bxd5? Qxd5 16.Qxb4 hxg3 lets the attack decide.", "ch2-c2-premature", refs("ch2-c2-premature")),
  ...
  diagramBlock("ch2-d23-block", spanId(32, "left"), "CH2-D23"),
  ...
  variation("ch2-c2-critical-block", spanId(32, "right"), "The critical 15...Ncxb4", "15...Ncxb4 16.a3 Nc6 17.Nc3 Kb8 18.Qb3 Nb6 19.Ne2 e5 20.Rxc6! bxc6 21.a4 e4 22.a5 Rh6 23.axb6 cxb6 24.f3! exf3 25.Bxf3 g5 26.Bg2±. White's light-squared bishop should prove the advantage.", "ch2-c2-critical", refs("ch2-c2-critical"), "CH2-D24"),
  ...
  { id: "ch2-conclusion", type: "assessment", status: "source-verified", sourceSpanId: spanId(33, "right"), text: "The first part of the chapter shares many similarities with GM 1, with some general improvements added along the way. The overall assessment remains favourable for White. After 5...Bd7 6.Ne5 Bc6 7.Nxc6 Nxc6 8.O-O Qd7 9.e3, the most critical test is 9...O-O-O, which has recently been employed with increasing frequency at the top level. Black aims to launch a quick kingside attack before the unsafe position of his own king is exploited. White must remain alert, but the analysis shows how to maintain an initiative in all cases.", moveRefs: [...selected("ch2-opening", [["5...Bd7", 9], ["6.Ne5", 10], ["Bc6", 11], ["7.Nxc6", 12], ["Nxc6", 13], ["8.O-O", 14]]), ...selected("ch2-c-main", [["Qd7", 0], ["9.e3", 1]]), ...selected("ch2-c2-main", [["9...O-O-O", 0]])] },
];
...
const diagramSpecs: DiagramSpec[] = [
  ...
  { id: "CH2-D18", sourceSpanId: spanId(30, "right"), role: "C1) position after 14...Be7", lineId: "ch2-c1-main", moveIndex: 10 },
  { id: "CH2-D19", sourceSpanId: spanId(31, "left"), role: "C1) central novelty 15.d5N", lineId: "ch2-c1-main", moveIndex: 11 },
  { id: "CH2-D20", sourceSpanId: spanId(31, "left"), role: "C1) position after the central exchanges", lineId: "ch2-c1-main", moveIndex: 15 },
  { id: "CH2-D21", sourceSpanId: spanId(31, "right"), role: "C2) position after 9...O-O-O", lineId: "ch2-c2-main", moveIndex: 0 },
  { id: "CH2-D22", sourceSpanId: spanId(32, "left"), role: "C2) attack after 17.Qb3N", lineId: "ch2-c2-h5", moveIndex: 13 },
  { id: "CH2-D23", sourceSpanId: spanId(32, "left"), role: "C2) main position after 13.Rfc1", lineId: "ch2-c2-main", moveIndex: 7 },
  { id: "CH2-D24", sourceSpanId: spanId(32, "right"), role: "C2) critical line after 19.Ne2", lineId: "ch2-c2-critical", moveIndex: 7 },
