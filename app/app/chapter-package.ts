...
export function parseChapterManifest(value: unknown): ChapterManifestV1 {
  ...
  if (manifest.id >= 6 && manifest.compatibility !== "chapter1-legacy") invariant(manifest.lesson?.publicationProfile === "authored", "newer chapters require the authored publication profile");
